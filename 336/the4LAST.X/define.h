...
#define RSSEND_PRIO            8
#define LCDTASK_PRIO           10
#define BOTTASK_PRIO           1

#define _WAITING 0
#define _RUNNING 1
#define BUFSIZE 8
extern unsigned char dataReady,datasent;
extern unsigned char rcvbuffer[BUFSIZE], ridx;
extern unsigned char sndbuffer[BUFSIZE/2], sidx;
extern unsigned char STATE, duration[4], _posTx[4];

extern char posX;
extern char posY, T[4], dir, dx[4], dy[4];
extern unsigned char board[25]; 
extern unsigned char remTime;
extern unsigned int disTime[25];
extern unsigned int tmrcnt0;
extern unsigned char nextAct;
