...
volatile unsigned char stack1[DEFAULT_STACK_SIZE*2];
#pragma		udata      STACK_B   
volatile unsigned char stack2[DEFAULT_STACK_SIZE*2];
...
rom_desc_tsk rom_desc_task2 = {
	RSSEND_PRIO,                       /* prioinit from 0 to 15       */
	stack2,                           /* stack address (16 bits)     */
	RSSEND,                            /* start address (16 bits)     */
	READY,                            /* state at init phase         */
	RSSEND_ID,                         /* id_tsk from 0 to 15         */
