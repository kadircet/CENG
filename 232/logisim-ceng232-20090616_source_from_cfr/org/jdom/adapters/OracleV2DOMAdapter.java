...
extends AbstractDOMAdapter {
    ...
    public Document getDocument(InputStream in, boolean validate) throws IOException, JDOMException {
        try {
            ...
            Class class_ = class$org$xml$sax$InputSource != null ? class$org$xml$sax$InputSource : (OracleV2DOMAdapter.class$org$xml$sax$InputSource = OracleV2DOMAdapter.class$("org.xml.sax.InputSource"));
            arrclass[0] = class_;
