...
extends AbstractDOMAdapter {
    ...
    public Document createDocument() throws JDOMException {
        try {
            ...
            throw new JDOMException(String.valueOf(e.getClass().getName()) + ": " + e.getMessage() + " while creating document", e);
        }
    }
    ...
    public Document getDocument(InputStream in, boolean validate) throws IOException, JDOMException {
        try {
            ...
            Class class_ = class$java$lang$String != null ? class$java$lang$String : (XML4JDOMAdapter.class$java$lang$String = XML4JDOMAdapter.class$("java.lang.String"));
            arrclass[0] = class_;
            ...
            if (validate) {
                ...
                Class class_2 = class$org$xml$sax$ErrorHandler != null ? class$org$xml$sax$ErrorHandler : (XML4JDOMAdapter.class$org$xml$sax$ErrorHandler = XML4JDOMAdapter.class$("org.xml.sax.ErrorHandler"));
                arrclass2[0] = class_2;
            ...
            Class class_3 = class$org$xml$sax$InputSource != null ? class$org$xml$sax$InputSource : (XML4JDOMAdapter.class$org$xml$sax$InputSource = XML4JDOMAdapter.class$("org.xml.sax.InputSource"));
            arrclass3[0] = class_3;
